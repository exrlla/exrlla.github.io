  ...
  <div class="px-8">
    <div class="" >
      <div class="flex mt-10">
        ...
        <h2 class="font-Sora text-gray-600 text-4xl">
          Illinois Design Consulting Website</h2>
      </div>
      <p class="font-Sora text-gray-500 mt-4">
    ...
    <div>
        ...
        <dl class="mt-16 grid grid-cols-1 gap-y-2 md:grid-cols-2 md:gap-y-6 lg:gap-x-2">
          <div class="border-t border-gray-200">
            <dt class="font-Sora text-gray-500 text-lg" id="bolder-text">Role</dt>
            <dd class="font-Sora mt-2 text-sm text-gray-500">Design Consultant</dd>
          </div>
  
          <div class="border-t border-gray-200 pt-4">
            <dt class="font-Sora text-gray-500  text-lg" id="bolder-text">Team</dt>
            <dd class="font-Sora mt-2 text-sm text-gray-500">Allison Oh <br> Angeline Mendez <br/> June Chun <br/> Kiran Pillai <br/> Emaan Kashif <br/> Anika Solapurkar</dd>
          </div>
  
          <div class="border-t border-gray-200 pt-4">
            <dt class="font-Sora text-gray-500" id="bolder-text">Timeline</dt>
            <dd class="font-Sora mt-2 text-sm text-gray-500">Sep 2022 - Dec 2022</dd>
          </div>
  
          <div class="border-t border-gray-200 pt-4">
            <dt class="font-Sora text-gray-500 text-lg" id="bolder-text">The Problem</dt>
            <dd class="font-Sora mt-2 text-sm text-gray-500">Currently, the IDC website offers limited information and visuals for both members & nonmembers of IDC.
                However, as a new organization, it is important that IDC’s website be thorough enough to inform and attract new members & clients.
                Therefore, IDC asked Innovation Studio to redesign their website to improve functionality & accessibility.</dd>
          </div>
  
          <div class="border-t border-gray-200 pt-4">
            <dt class="font-Sora text-gray-500 text-lg" id="bolder-text">Skills</dt>
            <dd class="font-Sora mt-2 text-sm text-gray-500">
                Product Thinking <br/>
          ...
          <div class="border-t border-gray-200 pt-4">
            <dt class="font-Sora text-gray-500 text-lg" id="bolder-text">Tools</dt>
            <dd class="font-Sora mt-2 text-sm text-gray-500">
                Figma <br/>
                FigJam <br/>
                Notion </dd>
    ...
    <!-- Design Process: Competitor Analysis -->
      <h3 class="font-Sora text-red-300 text-3xl mt-10 md:text-4xl">
        research - competitor analyisis✧</h3>
      ...
      <h3 class="text-3xl md:text-4xl font-Sora mt-10 gap-x-8 text-red-300 ">
        Ideate</h3>
      ...
      <div class="grid ">
        <div>
          <p class="font-Sora mt-4 text-gray-500">
            ...
            <ul class="font-Sora text-gray-500 pb-5">
              <li>> Pages</li>
      ...
      <h3 class="font-Sora text-red-300 text-3xl mt-10 md:text-4xl">
        ...
        <p class="font-Sora mt-4 text-gray-500 "> 
          ...
          <p class="font-Sora text-lg text-gray-500" id="bolder-text">
            Some of the main takeaways from the user interviews were: <br/><br/>
        </p>
        <ul class="font-Sora text-gray-500 mb-10">
          <li>> There was a lack of community shown on the website.</li>
          <li>> The UI wasn't fully mobile-compatible, and users were turned away from it. </li>
          <li>> Students weren't getting all of the information they needed to know and consider applying for IDC. </li>
        </ul> 
      </div>
      <div class="flex justify-center">
        <img src="/assets/idc-4.png" alt="Illinois Design Consulting" class="md:w-2/3 mb-5 rounded-lg">
      </div>
      ...
      <h3 class="font-Sora text-red-300 text-3xl mt-10 md:text-4xl">
        visual identity!</h3>
  <div>
    <p class="font-Sora mt-4 mb-5 text-gray-500"> 
      Our team decided to prioritize University of Illinois branding while keeping a wide color hue selection. We wanted to make sure that the website was
    ...
    <div class="flex justify-center">
      ...
      <p class="mt-4 text-gray-500"> 
        <ul class="a font-Sora text-gray-500">
          <li> I got to learn so much about the design process! Asking the right questions is so important! Knowing to ask WHY is crucial. 
            A user can do anything but WHY did they do it? (Thanks Allison for this one!)  <br/><br/></li>
          <li>This was my first time conducting user interviews, and I learned so much about the user journey as you go through a product! 
            Going from the nav bar, or understanding why a user is going to a certain section of a page is really interesting.<br/><br/></li>
          <li>I got to work on a project team with designers from a variety of backgrounds, and it helped so much getting their feedback!! 
        ...
        <div class="mt-10 flex">
          <a href="/design">
            <h4 class="font-Sora text-xl text-red-400">↙ designs ✧ ˚ · .</h4>
          </a>
        </div>
  </div>
</div>
