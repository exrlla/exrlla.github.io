...
<div class="flex justify-center flex-col mx-12 xl:mx-60">
  ...
  <div class="flex flex-col items-center lg:items-start lg:flex-row mb-10">
    <div>
      <img alt="Ellie Popoca" class="w-90 md:w-80 rounded-lg" src="/assets/about_ellie.JPG">
        <div class="flex flex-col mt-4 md:w-80">
          ...
          <iframe title="spotify gif"style="border-radius:10px; margin-top:16px" src="https://open.spotify.com/embed/playlist/4rpa6cJaNWzXu4MKbOT5Oi?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
        </div>
      </div>
      <div class="flex flex-col lg:mx-10 mt-6">
        ...
        <p class="reg-text-main mr-2 mt-5">
          ...
          in all things tech + of course, some fun stuff here and there!✨ <br/> <br/>
        </p>
